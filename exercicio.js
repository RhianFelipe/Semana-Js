...
//Nova Array somente com números Ímpares //Divido em 2 const para reduzir e ser mais facil visualização
const getNewArrayImpar = randomNumber => randomNumber % 2 !== 0 //verifica se é impar
   const  newArrayImpar = randomNumbers.filter(getNewArrayImpar)
...
const countNumberLessThan501 = (accumulator,crazyNumber) =>
 ...
 const quantityLessThan501 = crazyNumbers.reduce(countNumberLessThan501,0)
 console.log(quantityLessThan501)
...
const numberSquared = numbers.map(number => number**2) //faz o número da Array elevado a 2
...
//Seleciona  na Array apenas os filmes abaixo do ano de 2000
...
//Formatando os nomes dos games
const NameCartGame = cart.reduce((accumulator,{ name })=> 
   `${accumulator}- ${name}\n`
,'') //para fazer uma string

console.log(NameCartGame)
